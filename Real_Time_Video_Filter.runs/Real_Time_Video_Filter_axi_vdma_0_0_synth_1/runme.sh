...
HD_PWD='A:/Documents/School/ENSC452/Real_Time_Video_Filter/Real_Time_Video_Filter.runs/Real_Time_Video_Filter_axi_vdma_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Real_Time_Video_Filter_axi_vdma_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Real_Time_Video_Filter_axi_vdma_0_0.tcl
