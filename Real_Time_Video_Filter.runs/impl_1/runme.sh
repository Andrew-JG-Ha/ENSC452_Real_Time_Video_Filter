...
HD_PWD='A:/Documents/School/ENSC452/Real_Time_Video_Filter/Real_Time_Video_Filter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Real_Time_Video_Filter_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Real_Time_Video_Filter_wrapper.tcl -notrace
