...
EAStep vivado -log Real_Time_Video_Filter_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Real_Time_Video_Filter_auto_pc_0.tcl
