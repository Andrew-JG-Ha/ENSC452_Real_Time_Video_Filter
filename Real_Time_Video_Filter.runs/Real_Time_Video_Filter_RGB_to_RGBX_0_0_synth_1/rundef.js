...
ISEStep( "vivado",
         "-log Real_Time_Video_Filter_RGB_to_RGBX_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Real_Time_Video_Filter_RGB_to_RGBX_0_0.tcl" );
